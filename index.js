...
module.exports = {
  ...
  TOPIC_MODULE_DELETING: 'TOPIC_MODULE_DELETING',
  TOPIC_MODULE_DELETED: 'TOPIC_MODULE_DELETED',
  TOPIC_MODULE_DELETE_FAILED: 'TOPIC_MODULE_DELETE_FAILED',
  TOPIC_MODULE_UPDATING: 'TOPIC_MODULE_UPDATING',
  TOPIC_MODULE_UPDATED: 'TOPIC_MODULE_UPDATED',
  TOPIC_MODULE_UPDATE_FAILED: 'TOPIC_MODULE_UPDATE_FAILED',
  MQTT_WS_PATH: '/mqttws'
}
